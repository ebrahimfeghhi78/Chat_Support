...
const LiveChatWidget = () => {
  ...
  const startSupportChat = async () => {
    try {
      ...
      if (window.chatHubConnection) {
        await window.chatHubConnection.invoke(
          "JoinRoom",
      ...
      addSystemMessage(
        "اتصال به پشتیبانی با شکست مواجه شد. لطفاً دوباره تلاش کنید."
      );
    }
  };
  ...
  const handleRegistration = async (e) => {
    ...
    try {
      const response = await api.post("/support/guest/auth", {
        name: guestInfo.name,
      ...
      >
        <div className="d-flex align-items-center gap-3">
          ...
          <div>
            ...
            {agentInfo && (
              <small className="opacity-75">{agentInfo.name}</small>
            )}
          </div>
        </div>
          ...
          {!isRegistered && !isAuthenticated ? (
            <div className="p-4 d-flex flex-column justify-content-center h-100">
              ...
              <p className="text-muted mb-4">
                لطفاً اطلاعات خود را وارد کنید تا گفتگوی شما با پشتیبانی آغاز
                شود.
              </p>
            ...
            <>
              ...
              <div style={styles.messageContainer}>
                    ...
                    >
                      ...
                      >
                        {message.type === 5 ? (
                          ...
                          <>
                            {!message.isGuest && (
                              <small className="d-block fw-semibold opacity-75 mb-1">
                                {message.senderName ||
                                  agentInfo?.name ||
                                  "پشتیبانی"}
                              </small>
                ...
                {isTyping && (
                  <div className="d-flex align-items-center gap-2 text-muted">
                    ...
                    <small>
                      {agentInfo?.name || "اپراتور"} در حال نوشتن...
                    </small>
                  </div>
                )}
              ...
              <div style={styles.inputContainer}>
                ...
                <input
                  ...
                  placeholder={
                    chatRoomId ? "پیام خود را بنویسید..." : "در حال اتصال..."
                  }
                ...
                <button
                  onClick={sendMessage}
                  disabled={!inputMessage.trim() || !chatRoomId}
